...
class IRdbSqlServerDatabaseInterface : public IRdbDatabaseInterface<T, IRdbSqlServerDialect, enabled>
{
public:
    IRdbSqlServerDatabaseInterface() = default;
...
QSqlDatabase IRdbSqlServerDatabaseInterface<T, enabled>::openDatatbase()
{
